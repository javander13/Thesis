...
class Decoder(Module):
    ...
    def forward(self, x, encFeatures):
        ...
        for i in range(len(self.channels) - 1):
            ...
            # and pass the concatenated output through the current decoder
            # block
    ...
    def crop(self, encFeatures, x):
        # grab the dimensions of the inputs, and crop the encoder features to
...
class UNet(Module):
    def __init__(
        self, encChannels=(
            3, 64, 128, 256), decChannels=(
            256, 128, 64), nbClasses=256, retainDim=True, outSize=(
    ...
    def forward(self, x):
        ...
        # pass the encoder features through decoder making sure that their
        # dimensions are suited for concatenation
        decFeatures = self.decoder(encFeatures[::-1][0], encFeatures[::-1][1:])

        # pass the decoder features through the regression head to obtain the
        # segmentation mask
